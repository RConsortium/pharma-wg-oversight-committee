...
2. The FDA has been interested in covariance adjustment for which there are R packages but not much in SAS. A paper on this (and maybe an CRAN Task View) would be helpful.
